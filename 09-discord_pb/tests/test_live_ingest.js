...
check(live.status({updated_at:100,connected:true,connected_since:90},100).connected_since,'1970-01-01T00:01:30.000Z')
check(live.status({updated_at:10,connected:true,connected_since:9},100).connected_since,null)
check(live.status({updated_at:100,connected:false,connected_since:90},100).connected_since,null)
